...
<div id="icon-tools" class="icon32"></div>
  ...
  This options page generates the <a href="http://wordpress.org/extend/plugins/list-category-posts/">List Category Posts</a> shortcode for you to use in your post/page. Please select the options below, copy the generated code and pase it in your page.
  <form method="post" >
    ...
    <input class='button-primary' type='submit' name='getcode' value='<?php _e('Get code'); ?>' id='submitbutton' />
  </form>
...
<?php if (isset($_POST['categoryid'])){ ?>
  ...
  <code>
    ...
    <?php if (isset($_POST['numberposts']) && $_POST['numberposts'] != -1): echo ' numberposts=' . intval($_POST['numberposts']); endif; ?>
    <?php if (isset($_POST['tags']) && $_POST['tags'] != ''): echo ' tags=' . preg_replace('/\s/', '', $_POST['tags']); endif; ?>
    <?php echo ']';?>
  </code>
